...
Implements the ``mpm __complete_catalog_versions <current-token>`` hidden
...
def _spawn_background_refresh(url: str, catalog_source: str) -> None:
    ...
    Args:
        ...
        catalog_source: Full ``<url>@<ref>`` value for MPM_CATALOG_SOURCES.
    """
    subprocess.Popen(
        [
            sys.executable,
